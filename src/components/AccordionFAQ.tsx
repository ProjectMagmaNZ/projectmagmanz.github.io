...
const faqData = [
  {
    ...
    answer: `While there is a broad range of year levels within our member demographic, there is no limit to which year you are in or what discipline you study! 
  ...
  },
  {
    ...
    answer: `Projects run either in Semester 1 or Semester 2. Usually from week 3 to about week 11 to allow prompt wrap ups and avoid assignment or exam clashes, with a bit of buffer time at the end.`
  },
  {
    question: '4. What skills do I need to contribute?',
    answer: `You do not have to be an expert in anything to meaningfully contribute! Any technical skills such as data science or programming in any language is welcome, but your passion to commit to a dedicated project is more important!`
  },
  {
    question: '5. How would PM projects benefit me?',
    answer: `While all our work amongst executive and project members is voluntary and pro-bono, it can be an excellent and unique boost to your CV and technical experience. Consider this as simply a different form of volunteering and demonstrating your leadership abilities in the real non-profits you work with. In addition, by being part of a team and taking part in liaising with the client team(s), you become more confident at both technical and non-technical communication, which are a set of crucial skills for your studies and career path ahead!
    `
  },
  {
